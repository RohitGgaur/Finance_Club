              ...
              <div class="container p-2">
                <div class="row text-center">
                  <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                    <div
                      class="rounded py-5 px-4 cards-background"
                      style={{
                        background: "#112e42",
                    ...
                    >
                      <img
                        ...
                        style={{ height: "30%", width: "53%" }}
                      />
                      <h5 class="mb-0">Manish Rao </h5>
                      <span
                        class="small text-uppercase"
                        style={{ color: "white" }}
                      >
                        Founder of Finance Club
                      </span>
                      <div class="social">
                        <a href="">
                  ...
                  <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                    ...
                    >
                      <img
                        ...
                        style={{ height: "30%", width: "53%" }}
                      />
                      <h5 class="mb-0">Mandeep Kumar</h5>
                      <span
                        class="small text-uppercase"
                        style={{ color: "white" }}
                      >
                  ...
                  <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                    ...
                    >
                      <img
                        ...
                        style={{ height: "30%", width: "53%" }}
                      />
                      <h5 class="mb-0">Ugrasen Singh</h5>
                      <span
                        class="small text-uppercase"
                        style={{ color: "white" }}
                      >
                ...
                <div class="row text-center">
                  <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                    ...
                    >
                      ...
                      <h5 class="mb-0">Aayush Sharma </h5>
                      <span
                        class="small text-uppercase"
                        style={{ color: "white" }}
                      >
                        Secretary of Finance Club
                      </span>
                      <div class="social">
                        <a href="">
                          <i class="bi bi-twitter mx-2"></i>
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Jayantika Jaiswal</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shashwat Mishra</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Virat Singh Tomer</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Aditi Yadav</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                      B.Tech Ch.E Final year
                    </span>
                    <div class="social">
                      <a href=" ">
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Amartya Narayan Tripathi</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Rishika Shrivastava</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shashank Shekhar Mishra</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shreya Srivastava</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                      B.tech ChE Final year
                    </span>
                    <div class="social">
                      <a href=" ">
                        <i class="bi bi-twitter-x mx-2"></i>
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shruti Pandey</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Aditya Kumar Singh</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Dileep Agrahari</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Garima Sharma</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Malaika Chaurasia</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Manvendra Sharma</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Priyanka Agrawal</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shivangi Mishra</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shubham Gupta</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Arav Prajapati</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Chaitanya Raj</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Devansh Pandey </h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Garvita Singh</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Himanshu Yadav</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Kajal Lakhotia</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Manish Agrahari</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Mansi Upadhyay</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Muskan Chiraniya</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Prashant Mishra</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Sakshi Jaiswal</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Shraddha Gupta</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
                ...
                <div class="col-xl-3 col-sm-3 mb-5 card-hover ">
                  ...
                  >
                    <img
                      ...
                      style={{ height: "30%", width: "53%" }}
                    />
                    <h5 class="mb-0">Tanisha Agrahari</h5>
                    <span
                      class="small text-uppercase"
                      style={{ color: "white" }}
                    >
