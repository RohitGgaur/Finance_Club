                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-xl-3 col-sm-3 mb-5">
                                        <div class=" rounded shadow-sm py-5 px-4 cards-background"style={{ "background": "#112e42" }} ><img
                                            ...
                                            <div class="social">
                                                <a href="https://twitter-x.com/Chaitan96195653"><i class="bi bi-twitter-x mx-2"></i></a>
                                                <a href=" "><i class="bi bi-facebook mx-2"></i></a>
                                                <a href="https://www.instagram.com/raj_chaitanya_/"><i class="bi bi-instagram mx-2"></i></a>
                                                <a href="https://www.linkedin.com/in/chaitanya-raj-882651257/"><i class="bi bi-linkedin mx-2"></i></a>
                                            </div>
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-xl-3 col-sm-3 mb-5">
                                        <div class=" rounded shadow-sm py-5 px-4 cards-background"style={{ "background": "#112e42" }} ><img
                                            src={ayushi3} alt=""
                                             class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" style={{height:"30%",width:"53%"}} />
                                            <h5 class="mb-0">Ayushi Ranjan</h5><span
                                                class="small text-uppercase" style={{color:"white"}}>B.tech EE 3rd year</span>
                                                 <div class="social">
                                                <a href=" "><i class="bi bi-twitter-x mx-2"></i></a>
                                                <a href=" "><i class="bi bi-facebook mx-2"></i></a>
                                    ...
                                    <div class="col-xl-3 col-sm-3 mb-5">
                                        <div class=" rounded shadow-sm py-5 px-4 cards-background"style={{ "background": "#112e42" }} ><img
                                            src={devansh3} alt=""
                                             class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm" style={{height:"30%",width:"53%"}} />
                                            <h5 class="mb-0">Devansh Soni</h5><span class="small text-uppercase" style={{color:"white"}}>B.tech EE 3rd year</span>
                                            <div class="social">
                                                <a href=" "><i class="bi bi-twitter-x mx-2"></i></a>
                                                <a href=" "><i class="bi bi-facebook mx-2"></i></a>
                                                <a href=" "><i class="bi bi-instagram mx-2"></i></a>
                                    ...
                                    <div class="col-xl-3 col-sm-3 mb-5">
                                        <div class=" rounded shadow-sm py-5 px-4 cards-background"style={{ "background": "#112e42" }} ><img
                                            ...
                                            <h5 class="mb-0">Aditya Kumar Singh</h5><span
                                                class="small text-uppercase" style={{color:"white"}}>B.tech ME Final year</span>
                                                 <div class="social">
                                                <a href=" "><i class="bi bi-twitter-x mx-2"></i></a>
                                                <a href=" "><i class="bi bi-facebook mx-2"></i></a>
                                                <a href=" "><i class="bi bi-instagram mx-2"></i></a>
